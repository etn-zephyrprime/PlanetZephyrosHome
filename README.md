...
pointing the host at this repo's root.

Styled to match the Electroneum Dashboard's own theme (`src/dashboard/theme.js` in
[ETNSubdomainService](https://github.com/etn-zephyrprime/ETNSubdomainService)) — same dark green
background, Orbitron display font, and green-glow accent.
